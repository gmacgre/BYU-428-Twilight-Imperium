...
class DataCache {
  ...
  List<List<SystemState>> boardState = [
    ...
    [
      ...
      airSpace: [
        // ShipData.defaultData[ShipType.flagship]!,
        ShipModel(8, 6, 1, 3, ShipType.flagship),
        ShipData.defaultData[ShipType.warsun]!,
        ShipData.defaultData[ShipType.dreadnought]!,
        ShipData.defaultData[ShipType.cruiser]!,
        ShipData.defaultData[ShipType.carrier]!,
        ShipData.defaultData[ShipType.destroyer]!,
        ShipData.defaultData[ShipType.fighter]!,
        ShipData.defaultData[ShipType.fighter]!,
      ], systemOwner: 0),
      SystemState(systemModel: SystemData.systemList['Empty']!,
      airSpace: [
